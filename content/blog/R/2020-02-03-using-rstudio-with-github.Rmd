...
Tutorial is focused towards installs on Ubuntu Linux and Microsoft Windows operating systems because that is what I primarily use. However, most instructions are the same across operating systems so a user of Mac OSX or other Linux distribution can follow along as well.
