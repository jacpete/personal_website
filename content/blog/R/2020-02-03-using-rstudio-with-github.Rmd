...
I intend this tutorial to be a soft introduction to git and GitHub for the average user of R that is looking to take better control of their code version history.

This tutorial is focused towards installs on Ubuntu Linux and Microsoft Windows operating systems because that is what I primarily use. However, most of the tutorial instructions are the same across operating systems so a user of Mac OSX or other Linux distribution can follow along as well.
...
PICTURE gitWebsiteDownload.png
...
PICTURE gitWebsiteWindowsDownload.png
...
PICTURE create project from website tutorial ![](/blog/2020-01-21-creating-a-website-with-hugo-rstudio-github-and-netlify_files/rstudioNewProject2.png)
